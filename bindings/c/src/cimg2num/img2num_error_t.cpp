...
static inline img2num_error_t cpp_error_to_c_error(img2num::Error cpp_error) {
    ...
    static_assert(static_cast<int>(img2num::Error::BAD_ALLOC)        == IMG2NUM_ERROR_BAD_ALLOC,           "enum mismatch");
    static_assert(static_cast<int>(img2num::Error::INVALID_ARGUMENT) == IMG2NUM_ERROR_INVALID_ARGUMENT,    "enum mismatch");
    static_assert(static_cast<int>(img2num::Error::RUNTIME)          == IMG2NUM_ERROR_RUNTIME,             "enum mismatch");
    static_assert(static_cast<int>(img2num::Error::UNKNOWN)          == IMG2NUM_ERROR_UNKNOWN,             "enum mismatch");
