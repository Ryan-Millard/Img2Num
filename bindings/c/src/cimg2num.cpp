...
void img2num_threshold_image(uint8_t *ptr, const int width, const int height,
    ...
    img2num::clear_last_error_and_catch(img2num::threshold_image, ptr, width, height, num_thresholds);
}

void img2num_black_threshold_image(uint8_t *ptr, const int width, const int height,
                                   const int num_thresholds) {
    img2num::clear_last_error_and_catch(img2num::black_threshold_image, ptr, width, height, num_thresholds);
}
...
void img2num_kmeans(const uint8_t *data, uint8_t *out_data, int32_t *out_labels,
    ...
    img2num::clear_last_error_and_catch(img2num::kmeans, data, out_data, out_labels, width, height, k, max_iter, color_space);
}
...
void img2num_bilateral_filter(uint8_t *image, size_t width, size_t height, double sigma_spatial,
    ...
    img2num::clear_last_error_and_catch(img2num::bilateral_filter, image, width, height, sigma_spatial, sigma_range, color_space);
}
...
char* img2num_labels_to_svg(uint8_t *data, int32_t *labels, const int width, const int height,
    ...
    char* result{nullptr};
    img2num::clear_last_error_and_catch([&](uint8_t *d, int32_t *l, int w, int h, int min_a, bool draw_contours) {
