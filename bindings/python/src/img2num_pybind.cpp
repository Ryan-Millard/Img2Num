...
PYBIND11_MODULE(img2num, m) {
    ...
    m.def("gaussian_blur_fft", [](py::array_t<uint8_t, py::array::c_style> image, size_t width, size_t height, double sigma) {
    ...
    m.def("invert_image", [](py::array_t<uint8_t, py::array::c_style> image, int width, int height) {
    ...
    m.def("threshold_image", [](py::array_t<uint8_t, py::array::c_style> image, int width, int height, int num_thresholds) {
    ...
    m.def("black_threshold_image", [](py::array_t<uint8_t, py::array::c_style> image, int width, int height, int num_thresholds) {
    ...
    m.def("bilateral_filter", [](py::array_t<uint8_t, py::array::c_style> image, size_t width, size_t height, double sigma_spatial, double sigma_range, uint8_t color_space) {
        img2num_bilateral_filter(image.mutable_data(), width, height, sigma_spatial, sigma_range, color_space);
    }, py::arg("image"), py::arg("width"), py::arg("height"), py::arg("sigma_spatial"), py::arg("sigma_range"), py::arg("color_space"),
    ...
    m.def("kmeans", [](py::array_t<uint8_t, py::array::c_style> data, int32_t width, int32_t height, int32_t k, int32_t max_iter, uint8_t color_space) {
    ...
    }, py::arg("data"), py::arg("width"), py::arg("height"), py::arg("k"), py::arg("max_iter"), py::arg("color_space"),
       "Run K-Means clustering. Returns a tuple: (quantized_image, labels_array)");


    m.def("labels_to_svg", [](py::array_t<uint8_t, py::array::c_style> data, py::array_t<int32_t, py::array::c_style> labels, int width, int height, int min_area) {
        char* svg_c_str = img2num_labels_to_svg(
            static_cast<const uint8_t*>(data.request().ptr),
            static_cast<const int32_t*>(labels.request().ptr),
        ...
        // you MUST free it here to prevent a memory leak. If it returns a static pointer, remove this line.
        free(svg_c_str); 

        return svg_py_str;
    }, py::arg("data"), py::arg("labels"), py::arg("width"), py::arg("height"), py::arg("min_area"),
