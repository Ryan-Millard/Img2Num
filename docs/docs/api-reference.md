...
| Language       | Docs                                           |
| :------------- | :--------------------------------------------- |
| **JavaScript** | [JS API Reference](/docs/js/api-reference)         |
| **C++**        | [C++ API Reference](/docs/cpp/api-reference)       |
| **C**          | [C API Reference](/docs/c/api-reference)           |
| **Python**     | [Python API Reference](/docs/python/api-reference) |
