...
This section of Img2Num is a centralized hub for developers, contributors, and curious users who want to explore the implementation details of the project.
This section focuses on **how the code and the project in its entirety works**.
...
- [Core docs](/docs/internal/core)
- [Bindings](/docs/internal/bindings)
- [Example app documentation](/docs/internal/example-apps)
- [Internal package docs](/docs/internal/packages)
- Development tools
  - [CLI scripts](/docs/internal/scripts)
