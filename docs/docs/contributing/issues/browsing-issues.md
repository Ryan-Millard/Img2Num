...
sidebar_label: Finding Issues
sidebar_position: 1
---

Not sure what to work on?

The GitHub issue tracker is the best place to find tasks that need contributors.
...
2. Ensure nobody else has already claimed it.
3. Claim the issue if you'd like to work on it.

See the [Issue Claims](../issue-claims) guide for details.

## Not sure what to choose?

If you're unsure whether an issue is suitable for you, feel free to leave a
comment asking for clarification.

Maintainers are happy to answer questions and point contributors toward issues
that match their experience level.
