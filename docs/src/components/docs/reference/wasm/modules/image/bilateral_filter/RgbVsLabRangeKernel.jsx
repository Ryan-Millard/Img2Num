const RgbVsLabRangeKernel = () => (
  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
    <svg style={{ width: '100%', maxWidth: '500px' }} viewBox="0 0 430 150" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Labels */}
      <text x="200" y="50" fontSize="12" fill="#ff6b6b">
        RGB LUT
      </text>
      <text x="200" y="110" fontSize="12" fill="#4dabf7">
        CIELAB (on-the-fly)
      </text>
      ...
      <text x="320" y="65" fontSize="10">
        Color difference &Delta;RGB
      </text>
      <text x="320" y="125" fontSize="10">
        Color difference &Delta;LAB
      </text>
    </svg>
