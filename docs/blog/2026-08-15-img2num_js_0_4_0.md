...
- `console-js` is now split into [`console-js-esm`](../../example-apps/#console-js-esm) and [`console-js-cjs`](../../example-apps/#console-js-cjs),
...
- The `html-js` example was rebuilt as a single shared template compiled into three self-contained variants -
  [ESM](../../example-apps/esm), [IIFE](../../example-apps/iife), and [UMD](../../example-apps/umd) - each deployable as plain static files with no build tooling at runtime.
