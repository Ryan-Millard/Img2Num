...
saveSVG(const std::string &filename, int width, int height,
  ...
  f << "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"" << width * 10
    << "\" height=\"" << height * 10 << "\" viewBox=\"0 0 " << width << " "
    << height << "\">\n";
  ...
  // Style Definitions
  f << "<style>\n";
  f << "  .chain { fill: none; stroke: #ccc; stroke-width: 0.2; "
  ...
  std::string colors[] = {"#FF0000", "#00AA00", "#0000FF",
                          "#FF00FF", "#FFAA00", "#00AAAA"};
  int colorIdx = 0;
