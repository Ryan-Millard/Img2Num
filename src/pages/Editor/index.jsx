...
/**
 * Interactive SVG editor UI that provides pan, pinch-zoom, wheel-zoom, and shape color reveal toggling.
 *
 * Renders controls to switch between color and preview modes, a viewport that supports:
 * - Single-pointer drag to pan,
 * - Two-finger pinch to scale while keeping the content point under the pinch midpoint anchored,
 * - Mouse-wheel zoom with scale clamping,
 * - Tap/click on SVG shapes to toggle revealing their original fill when in color mode.
 *
 * @returns {JSX.Element} The editor React element containing controls, the interactive viewport, and usage hints.
 */
