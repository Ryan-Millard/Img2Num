	...
	return (
		<GlassCard className={styles.container}>
			...
			<p>
				...
				>
					Img2Num
				</a> started as a simple goal: to <strong>learn how image processing works</strong>. 
				I wanted to experiment with transforming images at the pixel level—playing with colours and seeing how software could reinterpret visual data.
			</p>

			<p>
				As I explored the possibilities, I thought about my mom, who loves <strong>colour-by-number drawings</strong>. 
				I noticed that she would often switch apps because <strong>they only had a limited number of drawings</strong>. 
			...
			<p>
				...
				<strong>tech, creativity, and memory</strong>—a small way to honour someone who brought joy to my life, 
				while giving others a fun way to create art.
			</p>
		</GlassCard>
	);
};
