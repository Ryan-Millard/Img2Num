...
void rgb_to_lab(
    const Tin r_u8, const Tin g_u8, const Tin b_u8, Tout& out_l, Tout& out_a, Tout& out_b
) {
...
template <typename Tin, typename Tout>
void lab_to_rgb(
    const Tin L, const Tin A, const Tin B, Tout& out_r_u8, Tout& out_g_u8, Tout& out_b_u8
) {
