...
void _process(const uint8_t *image, const std::vector<double> &cie_image,
              std::vector<uint8_t> &result, const std::vector<double> &spatial_weights,
              const std::vector<double> &range_lut, int radius, double sigma_range, int start_row,
              int end_row, size_t height, size_t width, uint8_t color_space) {
