...
const HomeHelmet = () => (
  <Helmet>
    ...
    <meta name="description" content="Convert any image into a Color-by-Number template instantly in your browser! Drag & Drop or Choose File. Fast, lightweight, compiled C++ runs via WebAssembly." />
