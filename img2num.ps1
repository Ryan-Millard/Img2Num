...
Flags:
  ...
  --dh-img              Docker Hub shorthand for --img. Prefixes value with ryan-millard/img2num-dev:main
                          E.g.: ./img2num.ps1 sh --dh-img main
                            Resolves Docker image to ryan-millard/img2num-dev:main
  --ghcr-img            GitHub shorthand for --img. Prefixes value with ryan-millard/img2num-dev:main
                          E.g.: ./img2num.ps1 sh --ghcr-img main
                           Resolves Docker image to ghcr.io/ryan-millard/img2num-dev:main
